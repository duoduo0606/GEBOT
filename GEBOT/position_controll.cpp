...
Gebot_Gait::Gait_para gait_para_state[] =
        {
...
Gebot_Gait::Gebot_Gait()
{
    Gebot_Gait::time_int = 0.1;                 //时间间隔
    Gebot_Gait::time_step = 1;                //一次抬腿的时间
    Gebot_Gait::resolution_ratio = Gebot_Gait::time_step/Gebot_Gait::time_int;
